...
const uint8_t SolveImageData[] = {
  74, 9, 1, 0, 1, 0xFF, 1,
  
};
...
ColorIndex solvedColor(int x, int y) {
  x += solvedCount / 8 - 9;
  if (x < 0 || x >= 74) {
    return INDEX_BLACK;
  }
  return solveImage.getPixelIndex(x, y);
}
